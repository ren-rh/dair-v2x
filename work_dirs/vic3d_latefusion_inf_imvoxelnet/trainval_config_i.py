...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='KittiDataset',
            data_root=
            '/home/yc/dair-v2x/data/DAIR-V2X/cooperative-vehicle-infrastructure/infrastructure-side/',
            ann_file=
            '/home/yc/dair-v2x/data/DAIR-V2X/cooperative-vehicle-infrastructure/infrastructure-side/dair_vic_kitti_format_infos_train.pkl',
            split='training',
